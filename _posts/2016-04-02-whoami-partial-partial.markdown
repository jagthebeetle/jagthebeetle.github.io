...
categories: partials partials musing
---
In case it's unclear from the gratuitous waste of your browser's cycles the
Sierpinski carpet in the background is reveling in, I am a fan of recursion.

Not, alas, in a deeply rigorous, mathematical way, but in a way that often makes
presenting or writing something a little easier. When it isn't exactly clear what it
...
back to the theme in greater depth (perhaps when the great iterations of the universe
or my mind revisit this spot in a more poetic mood).
...
functional (in a certain sense anyway):
...
about this maligned language – no, not that it's like C but it's got those sweet
